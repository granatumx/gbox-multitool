          ...
          (organism_A == organism_B)):
            ...
            if ((gene_A in gene_score_top_genes) and
              (gene_B in gene_score_top_genes)):
                ...
                g.add_vertex(gene_A, label=gene_A, color=color_A, label_size=16, label_angle=1.5708, label_dist=5)
                g.add_vertex(gene_B, label=gene_B, color=color_B, label_size=16, label_angle=1.5708, label_dist=5)
